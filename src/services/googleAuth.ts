...
// Standard Google Sign-In Provider (Lightweight, No sensitive scopes)
...
// Google Classroom Provider with extended scopes for LMS integration
export const classroomProvider = new GoogleAuthProvider();
...
classroomProvider.addScope("https://www.googleapis.com/auth/drive.file");
classroomProvider.setCustomParameters({ prompt: "select_account" });

// Backwards compatibility alias
export const provider = standardGoogleProvider;
